...
# param_grid = {'alpha':[0.02, 0.024, 0.025, 0.026, 0.03, 0.1, 0.001,0.003,0.005, 0.007,0.0001,0.0005]}
param_grid = {
    'alpha_1' :[0.01,0.001,0.0001,0.00001,0.1], 
    'alpha_2':[0.01,0.001,0.0001,0.00001,0.1], 
    'lambda_1':[0.01,0.001,0.0001,0.00001,0.1],
    'lambda_2':[0.01,0.001,0.0001,0.00001,0.1]
}
...
outpath = "output/BayesianRidgeRegression"
...
dt.to_csv(open(os.path.join(outpath,"bayesianridge.csv"),'w'),sep=',',index=False)
