...
print(len(index),len(a),len(b),len(scores), len(classes),len(aTokens),len(bTokens),len(cosineSentSim),len(euclideanSentSim),len(sqeuclideanSentSim),len(correlationSentSim),len(cityblockSentSim),len(wmdw2v),len(isGeneratedData))
