...
# #### 2. numeric entries converted to a string of tokens (Not doing anything now)
...
for eachData in tqdm(pairs):
    aTokens.append( CustomTokenizer(eachData[0]))
    bTokens.append( CustomTokenizer(eachData[1]))
    #print (aTokens)
